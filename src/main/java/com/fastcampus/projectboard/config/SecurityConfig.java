...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
                                                   OAuth2UserService<OAuth2UserRequest, OAuth2User> oAuth2UserOAuth2UserService)
            throws Exception {
        return http
    ...
    @Bean
    public OAuth2UserService<OAuth2UserRequest, OAuth2User> oAuth2UserOAuth2UserService(
        ...
        return userRequest -> {
            ...
            String username = registrationId + " " + providerId;
