...
class HashtagServiceTest {
    ...
    @DisplayName("분문을 파싱하면, 해시태그 이름들을 중복 없이 반환 한다")
    @ParameterizedTest(name = "[{index}] \"{0}\" => {1}")
    @MethodSource()
    public void givenContent_whenParsing_thenReturnUniqueHashtagName(String input, Set<String> expected) throws Exception {
    ...
    static Stream<Arguments> givenContent_whenParsing_thenReturnUniqueHashtagName() {
        return Stream.of(
